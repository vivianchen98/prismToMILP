...
prefs = ['[0.33, 0.33, 0.33];[0.75, 0.05, 0.05]', '[0.33, 0.33, 0.34];[0.01, 0.01, 0.01]']

filenames = []
for s in states:
    filenames.append(solution + '_' + str(s) + ';3;' + prefs[0] + '.sol')
    filenames.append(solution + '_' + str(s) + ';3;' + prefs[1] + '.sol')
