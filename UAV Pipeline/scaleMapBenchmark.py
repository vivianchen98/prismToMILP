...
def findDestState():
    ...
    #b = open("uav.tra", "r")
    #for line in b:
        #if "operator_stop" in line:
            #line = line.split(" ")
            #destState = int(line[0])

    destState = []
    for i in range(5532,8208,1):
        destState.append(i)
...
def main():
    ...
    print("Creating UAV Map With " +str(objectives)+ " Objective(s).")
    ...
    os.system("sh prism -javastack 1g uav.prism uavproperties.pctl -exportmodel .tra,sta,lab -exporttransrewards uav.rew  -exportresults resultsLog.txt")
