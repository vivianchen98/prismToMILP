...
python parse.py simple_map 8 12
...
prism simple_map0.prism post-decision.props -exportresults post-decisionLog0.txt
prism simple_map1.prism post-decision.props -exportresults post-decisionLog1.txt
prism simple_map4.prism post-decision.props -exportresults post-decisionLog4.txt
